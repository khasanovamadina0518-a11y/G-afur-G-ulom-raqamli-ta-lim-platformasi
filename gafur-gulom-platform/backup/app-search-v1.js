...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('poem-title')) {
        ...
        // "Yangi she'r" tugmasiga event listener
    ...
    // She'rlarni yuklash (agar poems-container bo'lsa)
...
function displayRandomPoem() {
    ...
    // Tasodifiy she'r tanlash
    currentPoemIndex = Math.floor(Math.random() * allPoems.length);
...
async function loadStatistics() {
    ...
    // Agar bu elementlar sahifada bo'lmasa, hech narsa qilmaymiz
